...
describe("Services Page", () => {
  it("renders the page header and navigation", () => {
    ...
    expect(
      screen.getByText(/Discover the various programs and services/),
    ).toBeInTheDocument();
  });
  ...
  it("renders all seven service sections", () => {
    ...
    expect(
      screen.getByTestId("service-dhamma-explanation"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("service-meditation-guidance"),
    ).toBeInTheDocument();
  ...
  it("displays correct service titles", () => {
    ...
    expect(
      screen.getByRole("heading", { name: "Dhamma Discussion" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("heading", { name: "Dhamma Explanation" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("heading", { name: "Meditation Guidance" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("heading", { name: "Mahaguru Meetup" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("heading", { name: "Weekly Clarity Q&A" }),
    ).toBeInTheDocument();
    expect(
  ...
  it("displays complete service descriptions", () => {
    ...
    expect(
      screen.getByText(
        (content) =>
          content.includes("Our signature monthly") &&
          content.includes("cornerstone event"),
      ),
    ).toBeInTheDocument();
    expect(
    ...
    expect(
      screen.getByText(
        (content) =>
          content.includes("Join our interactive") &&
  ...
  it("has placeholder external links for other services", () => {
    ...
    const meditationGuidanceLink = screen.getByTestId(
      "cta-meditation-guidance",
    );
